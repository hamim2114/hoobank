...
const FeatureCard = ({icon,title,content,index}) =>(
  <div data-aos='slide-up' className={`flex flex-row p-6 rounded-[20px] mb-6 feature-card`}>
  ...
  return (
    <section id="features" className="sm:py-16 py-6 flex md:flex-row flex-col">
      <div className="flex justify-center items-start flex-1 flex-col">
        <h2 className="font-poppins font-semibold xs:text-[48px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full " data-aos="slide-left">
